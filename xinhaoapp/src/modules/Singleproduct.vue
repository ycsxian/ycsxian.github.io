...
<div>
    ...
    <div id="J-main-wrapper" class="main-wrapper container">
          <viewspot-component ref="viewspot" :currentTabProducts="currentTabProducts" :tabInfor="configData[0]" :public="public" :componentData="componentData"></viewspot-component>
...
export default {
  ...
  data () {
    return {
      msg: 'this is test for singleproduct.vue!!',
      currentTabProducts:[],
      currentStyle:'',
  ...
  mounted(){
    ...
    this.$store.dispatch('createMetricAct','singleproduct');
  },
  methods:{
    ...
    setBodyMod(){
      $('body').addClass('mod1');
        ...
        this.$set(this.public,'module','singleproduct');
